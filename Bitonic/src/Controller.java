...
public class Controller {
	...
	// ############# Konfiguration #############
	final static int cubeSizeStart = 1;
	final static int cubeSizeMax = 50;
	final static int cubeSizeInc = 1;
	final static int amountZahlen = 10240000;
	final static int maxGeneratorThreads = 8;
	static int amountRuns = 20;
	...
	public static void main(String[] args) throws InterruptedException, BrokenBarrierException {
		...
		int[] ZahlenUnsorted = new int[amountZahlen];
		...
		for (cubeSizeCurrent = cubeSizeStart; cubeSizeCurrent <= cubeSizeMax; cubeSizeCurrent += cubeSizeInc) {
			...
			for (int i = 0; i < amountRuns; ++i) {
				...
				ZahlenUnsorted = new int[amountZahlen];
			}
